...
- `2023.12` BioT5: Enriching Cross-modal Integration in Biology with Chemical Knowledge and Natural Language Associations. [EMNLP 2023](https://aclanthology.org/2023.emnlp-main.70.pdf)
...
- `2024.06` MolX: Enhancing Large Language Models for Molecular Learning with A Multi-Modal Extension.  MolX: Enhancing Large Language Models for Molecular Learning with A Multi-Modal Extension. [arXiv](https://arxiv.org/pdf/2406.06777)
...
- `2024.08` BioT5+: Towards Generalized Biological Understanding with IUPAC Integration and Multi-task Tuning. [ACL 2024](https://aclanthology.org/2024.findings-acl.71.pdf)
- `2024.09` ChemDFM-X: Towards Large Multimodal Model for Chemistry. [arXiv](https://arxiv.org/pdf/2409.13194)
- `2025.02`  Mol-LLaMA: Towards General Understanding of Molecules in Large Molecular Language Model.   Mol-LLaMA: Towards General Understanding of Molecules in Large Molecular Language Model. [arXiv](https://arxiv.org/pdf/2502.13449) 
...
- `2025.02` Probing the limitations of multimodal language models for chemistry and materials research. [arXiv](https://arxiv.org/pdf/2411.16955v2)
